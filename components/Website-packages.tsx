...
function WebPackages() {
  ...
  const plans = [
    {
      name: "Starter",
      price: { onetime: 189 }, // Use a one-time price for Basic plan
      features: [
    ...
    },
    {
      ...
      features: [
        ...
        "E-commerce with product pages and cart.",
        "Advanced SEO and analytics integration.",
        "Interactive forums or booking systems.",
        "Priority Support",
      ],
    },
  ];
